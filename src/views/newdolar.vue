<script>
import dolar from "../components/indice.vue";
...
export default {
  ...
  methods: {
    async submitFile() {
      await axios.post("http://localhost:8000/dolar/", this.empreendimento);
      alert("Dolar registrado com sucesso!"), this.$router.push("/");
    },
  },
  computed: {
        ...
        <form action="#">
          ...
          <div class="container">
            <div class="form-header">
              <div class="title">
                <h1>Adicione um novo postDolar:</h1>
              </div>
            </div>
